...
const CustomPrevArrow = ({ onClick }: { onClick?: React.MouseEventHandler<HTMLButtonElement> }) => {
  return (
    <button
      onClick={onClick}
      className="absolute top-[55%] -left-[30px] transform -translate-y-[100%] shadow-[0px_2px_4px_rgba(0,0,0,0.3)] rounded-full bg-white z-10"
    >
...
const CustomNextArrow = ({ onClick }: { onClick?: React.MouseEventHandler<HTMLButtonElement> }) => {
  return (
    <button
      onClick={onClick}
      className="absolute top-[55%] -right-[30px] transform -translate-y-[100%] shadow-[0px_2px_4px_rgba(0,0,0,0.3)] rounded-full bg-white z-10"
    >
