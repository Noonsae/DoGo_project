    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      <div className="bg-white w-full h-full max-w-none sm:max-w-[500px] md:max-w-[600px] sm:h-auto rounded-none sm:rounded-lg shadow-lg overflow-auto">
        ...
        <div className="p-4 mt-6 flex justify-end">
          <button
            type="button"
            className="text-[18px] sm:text-[16px] mr-[16px] sm:mr-[24px]  md:text-[18px] w-[117px] sm:w-[111px] h-[44px] px-6 py-2 flex items-center gap-2 leading-[135%] text-center justify-center bg-[#B08968] text-white rounded-lg font-semibold hover:bg-[#8E6B4A] transition"
