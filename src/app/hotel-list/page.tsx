            ...
            <div className="flex-1 border border-gray-300 rounded-md">
              <Link href="">
                {hotels.map((hotel, index) => (
                  <li className="w-[872px] h-[277px] flex items-center" key={index}>
                    {/* 이미지 */}
                    ...
                    {/* 텍스트 */}
                    <div className="ml-[16px] h-[245px] flex items-start">
                    ...
                    <li>{hotel.address}</li>
                    <p className="flex items-end justify-items-end">{hotel.min_price}원</p>
                  </li>
                ))}
              </Link>
            </div>
